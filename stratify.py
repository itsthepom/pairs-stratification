...
class stratify(baseUIClass):
    ...
    def construct(self, pagebgnd):
        ...
        self.overallNSStringLabel.grid(row=5, column=4, sticky="w", padx=20)
        ...
        self.overallEWStringLabel.grid(row=6, column=4, sticky="w", padx=20)
        ...
        self.strat1NSStringLabel.grid(row=7, column=4, sticky="w", padx=20)
