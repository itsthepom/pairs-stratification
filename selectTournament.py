...
class selectTournament(baseUIClass):
    ...
    def construct(self, pagebgnd: str):
        ...
        self.errorLabel.grid(row=12, column=0, columnspan=2, sticky="w", padx=20, pady=(20, 5))
        ...
        self.preStratLabel.grid(row=13, column=0, columnspan=2, sticky="w", padx=20)
        self.labels.append(self.preStratLabel)

        label = tb.Label(self.frame, text="", font=("Arial", 10), justify='left')
        label.grid(row=14, column=0, columnspan=2, sticky="nw", padx=420, pady=250)
        self.labels.append(label)
