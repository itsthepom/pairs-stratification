...
class options(baseUIClass):
    ...
    def construct(self, pagebgnd):
        ...
        label = tb.Entry(self.frame, textvariable=self.resultsPathVar, width=102, font=("Arial", 10))
        ...
        label.grid(row=6, column=0, columnspan=2, sticky="w", padx=20, pady=(0, 10))
        self.labels.append(label)
        ...
        label = tb.Entry(self.frame, textvariable=self.outputsPathVar, width=102, font=("Arial", 10))
        ...
        label.grid(row=9, column=0, columnspan=2, sticky="w", padx=20, pady=(10, 5))
        self.labels.append(label)
        label = tb.Label(self.frame, text="This is where .PBN files are located.", font=("Arial", 10), justify='left')
        label.grid(row=10, column=0, columnspan=2, sticky="w", padx=20, pady=(0, 10))
        self.labels.append(label)
        ...
        label = tb.Entry(self.frame, textvariable=self.hrecPathVar, width=102, font=("Arial", 10))
        ...
        label.grid(row=13, column=0, columnspan=2, sticky="w", padx=20, pady=(10, 5))
        self.labels.append(label)
        label = tb.Label(self.frame, text="This allows you to customise the webpage.", font=("Arial", 10), justify='left')
        label.grid(row=14, column=0, columnspan=2, sticky="w", padx=20, pady=(0, 10))
        self.labels.append(label)
        ...
        label = tb.Entry(self.frame, textvariable=self.webpTmplVar, width=102, font=("Arial", 10))
        ...
        label.grid(row=17, column=0, columnspan=2, sticky="w", padx=20, pady=(10, 5))
        self.labels.append(label)
        label = tb.Label(self.frame, text="You can supply different ones while stratifying a tournament", font=("Arial", 10), justify='left')
        label.grid(row=18, column=0, columnspan=2, sticky="w", padx=20, pady=(0, 10))
        self.labels.append(label)
