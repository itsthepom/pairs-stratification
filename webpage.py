...
class webpage(baseUIClass):
    ...
    def construct(self, pagebgnd: str):
        ...
        label.grid(row=5, column=0, columnspan=2, sticky="w", padx=20, pady=(20, 5))
        self.labels.append(label)
        ...
        label.grid(row=8, column=0, columnspan=2, sticky="w", padx=20, pady=(20, 5))
        self.labels.append(label)
        ...
        label.grid(row=13, column=0, columnspan=2, sticky="nw", padx=420, pady=250)
        self.labels.append(label)
